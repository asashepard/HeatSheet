...
\begin{lstlisting}[basicstyle=\ttfamily\small,frame=single]
  ...
  <duplicate>             ::= <athlete-duplicate>
                            | <roster-duplicate>
                            | <meet-duplicate>

  <athlete-duplicate>     ::= duplicate <athlete> to <Identifier>

  <roster-duplicate>      ::= duplicate <roster> to <Identifier>

  <meet-duplicate>        ::= duplicate <meet> to <Identifier>
